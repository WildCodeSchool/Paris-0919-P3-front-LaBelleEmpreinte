  ...
  render() {
    ...
    return (
      <div>
        ...
        {this.state.objetsSelected.name || this.state.besoinsSelected.name ? 
          <DisplayArticles objet={this.state.objetsSelected.name} besoin={this.state.besoinsSelected.name} />
          : null }
      </div>
    );
  }
